...
namespace TMPro
{
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public CharacterSelectionEvent onCharacterSelection { get; set; } = new();
        ...
        /// </summary>
        [field: SerializeField]
        public SpriteSelectionEvent onSpriteSelection { get; set; } = new();
        ...
        /// </summary>
        [field: SerializeField]
        public WordSelectionEvent onWordSelection { get; set; } = new();
        ...
        /// </summary>
        [field: SerializeField]
        public LineSelectionEvent onLineSelection { get; set; } = new();
